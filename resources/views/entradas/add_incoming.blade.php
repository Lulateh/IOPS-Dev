...
<div class= "mt-10 flex justify-center ">
    <div class="bg-lilac bg-opacity-20 lg:w-3/4 md:w-3/4 max-sm:w-[24rem] p-10 rounded-lg shadow-lg">
        ...
        <form action="{{route('incoming.post')}}" method="POST">
            ...
            <div class="grid lg:grid-cols-2 md:grid-cols-2  gap-8 font-Poppins">
                ...
                Proveedor</label>
                    <div class="relative inline-block  mb-5">
                        <select name="prov_id" class="block appearance-none lg:w-[31.6rem] text-center border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:shadow-outline md:w-[16rem] max-sm:w-[16rem]" style="background-color: rgb(255, 255, 255);">
            ...
            <div class="lg:ml-[16rem] md:items-center">
                ...
                <input type="number" name="cantidad" id="cantidad" class="max-sm:w-[16rem] w-[31.6rem] p-2 mb-4 bg-white rounded-lg text-black" value="{{ old('cantidad') }}" required>
                    @error('cantidad')
                    <div class="text-red-600 mt-1">{{ $message }}</div> 
                    @enderror
            </div>
