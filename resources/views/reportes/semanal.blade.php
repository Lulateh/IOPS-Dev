...
<div class="min-h-screen bg-gray-100">
    <div class="flex justify-between p-4">
        ...
        <div class="space-x-2 pt-6">
            <a href="{{ route('reporte.diario') }}" class="px-4 py-2 bg-gray-200 text-gray rounded">Reporte diario</a>
            <a href="{{ route('reporte.semanal') }}" class="px-4 py-2 bg-[#26413C] text-white rounded">Reporte semanal</a>
    ...
    <div class="container mt-8 rounded max-w-[75%] float-right mr-[3.8rem]">
        <table class="min-w-full bg-white">
            ...
            <tbody>
                ...
                <tr>
                    <td class="py-2 px-4 border-b">Cigarros Malboro Blue</td>
                    <td class="py-2 px-4 border-b">Malboro</td>
                    <td class="py-2 px-4 border-b">Cigarros</td>
                    <td class="py-2 px-4 border-b">₡2275.00</td>
