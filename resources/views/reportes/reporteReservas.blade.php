        ...
        <div>
            <div class="flex flex-row mt-10 ml-20">
                    ...
                    <div class="space-x-2 pt-6 ml-[27rem]">
                        ...
                        <a href="{{ route('reporte.reservas') }}" class="px-4 py-2 bg-[#26413C] text-white rounded">Reporte de reservas</a>
                    </div>
        ...
        <div class="ml-20 mt-5 overflow-y-auto">
            ...
            <div class=" mt-8 rounded h-[26rem]  mr-10">
                <table id="salesReport" class="min-w-full bg-white display compact ">
                        <thead>
                            <tr>
                                <th class="py-2 px-4 border-b bg-[#64746B] text-white dt-head-center">Numero de reserva</th>
                                ...
                                <th class="py-2 px-4 border-b bg-[#64746B] text-white dt-head-center">Cantidad en reserva</th>
                                <th class="py-2 px-4 border-b bg-[#26413C] text-white dt-head-center">Cliente</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php
