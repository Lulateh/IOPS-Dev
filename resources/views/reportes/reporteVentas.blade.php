        ...
        <div>
            <div class="flex flex-row mt-10 ml-20">
                    ...
                    <div class="space-x-2 pt-6 ml-[27rem]">
                        <a href="{{ route('reporte.ventas') }}" class="px-4 py-2 bg-main-blue text-white rounded">Reporte de ventas</a>
                        <a href="{{ route('reporte.compras') }}" class="px-4 py-2 bg-gray-200 text-main-blue rounded">Reporte de compras</a>
                        <a href="{{ route('reporte.reservas') }}" class="px-4 py-2 bg-gray-200 text-main-blue rounded">Reporte de reservas</a>
                    </div>
