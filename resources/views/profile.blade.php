...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-20  px-5 sm:px-10 lg:px-20">
 ...
 <div class="bg-teal-950 bg-opacity-25 p-6 rounded-lg shadow-lg flex flex-col h-full">
    ...
    <a href="#" class="bg-main-green text-white w-24 h-24 rounded-full hover:bg-gray-600 flex items-center justify-center">
     ...
     <div class="ml-4 flex flex-col justify-center h-full text-xl font-coda">
        <p class="text-black mb-2">Nombre Producto</p>
        <p class="text-black">Codigo Producto</p>
    </div>

    <div class="border-l-4 border-dotted border-main-green h-5/6 w-1 mx-5"></div>
    ...
    <a href="#" class="bg-main-green text-white w-24 h-24 rounded-full hover:bg-gray-600 flex items-center justify-center">
     ...
     <div class="bg-white rounded-lg shadow-md w-full h-52 flex items-center px-4">
     <div class="ml-4 flex flex-col justify-center h-full text-xl font-coda">
    ...
    <div class="flex flex-col justify-center h-full text-xl font-Coda mt-5">
        <p class="text-black mb-5">12 Unid</p>
        <p class="text-black mb-5">12 Unid</p>
        <p class="text-black mb-5">12 Unid</p>
    </div>
     </div>
