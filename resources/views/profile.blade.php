...
<body>
    ...
    <div class="mt-5">
        <a href="{{ route('home') }}" class="ml-20 text-main-green font-Coda hover:underline text-2xl">  
            ← Volver
        </a>
    </div>


   <div class="flex flex-col lg:flex-row justify-center py-10 mx-4">

    <div class="bg-lightB bg-opacity-20 p-6 rounded-lg flex flex-col items-center w-full lg:w-[20%] mr-10 mb-4">
        ...
        <div class="text-center text-black">
            ...
            <p class="text-xl font-Coda mb-2">{{ Auth::user()->id }}</p>
        ...
        <div class="mt-6 mb-6 space-y-4 w-full">
            <a href="{{ route('editUser') }}" class="bg-main-blue font-Coda text-white px-4 py-2 rounded-lg mb-4 hover:bg-gray-600 w-full text-center block">Editar perfil</a>
            <a href="{{ route('logout') }}" 
               class="bg-main-blue font-Coda text-white px-4 py-2 rounded-lg mb-4 hover:bg-gray-600 w-full text-center block" 
    ...
    <div class="bg-lightB bg-opacity-20 p-6 rounded-lg flex flex-col w-full lg:w-[75%] mb-4">
    ...
    <div class=" p-6 col-span-1 mb-4 lg:mb-0 flex flex-col items-center justify-center text-center xl:py-28">
        ...
        <p class="text-xl  font-Coda mb-2">{{$empresa->id}}</p>
