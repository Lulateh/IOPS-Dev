                        ...
                        <div class="flex border border-black h-14 w-[24rem] mt-1 m-2">
                          <!-- foreach()-->
                            ...
                            <div class="flex ml-[12rem] mt-[0.76rem]">
                              ...
                              <p class="font-Poppins font-extrabold text-secondary-green text-2xl">cantidad</p>   
                ...
                <div class="flex-col">
                    ...
                    <div> 
                      <div class="bg-main-green bg-opacity-30 rounded-lg p-2 mb-6 font-Coda font-semibold columns-2 w-[36rem] h-[12rem]">
                        ...
                        <div class="flex-col text-lg text-left mt-12 ml-10">
                          <p>Cliente: Juanito</p>
                          <p>Contacto: 0000000</p>
                          <p>Fecha de entrega: 03/09/24</p>
                        </div>
    
                        <button onclick="showModalEditar()" class="align-end bg-main-green p-2 ml-32 m-4 mt-14 rounded-lg">
