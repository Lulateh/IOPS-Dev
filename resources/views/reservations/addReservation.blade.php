...
<div class="mt-8">
    <a href="{{ route('reservations') }}" class="ml-20 text-secondary-green font-Coda hover:underline text-4xl">  
    ← Volver
    </a>
</div>
<!-- --------------HEADER-------------- -->
...
<div class="flex-container mb-8 flex items-end justify-center">
    ...
    <div class="flex">
        ...
        <div class="flex border border-black h-14 w-[24rem] mt-1 ml-4 m-2">
            <div class="flex flex-col ml-10 mt-2">
                <p class="font-Coda text-sm m-0">Producto</p>
                <p class="font-Coda text-sm m-0">Marca: </p>
            </div>
            <div class="flex ml-[14rem] mr-6 mt-[0.76rem]">
                <p class="font-Poppins font-extrabold text-secondary-green text-xl">Cantidad</p>
            </div>
        </div>
                ...
                <div class="flex-col">
                    ...
                    <div> 
                      <div class="bg-card-bg bg-opacity-70  rounded-lg p-2 mb-6 font-Coda font-semibold columns-2 w-[36rem]">
                        ...
                        <select name ="client_id" class="block appearance-none w-[21.6rem] text-center border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:shadow-outline" style="background-color: rgba(38, 65, 60, 0.25);">
                        ...
                        <select name ="client_id" class="block appearance-none w-[21.6rem] text-center border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:shadow-outline" style="background-color: rgba(38, 65, 60, 0.25);">
                            <option value="1">Contacto de cliente</option>
                            <!-- aqui va un for each -->
                            <option value="1">numero cliente</option>
                            <!-- aqui va un for each -->
                        </select>
                        </div>
                    ...
                    <div>
                        <form action="{{ route('reservation.post') }}" method="POST">
                            @csrf
                            <select name ="prod_id" class="block appearance-none w-[31.6rem] mb-8 text-center border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:shadow-outline" style="background-color: rgba(38, 65, 60, 0.25);">
                            ...
                            <button type="submit" class="mt-4 text-white bg-main-green mx-auto flex p-2 rounded-lg">
                                Agregar producto
                            </button>
                        </form>
                    </div>
...
<button type="submit" class=" mb-8 bg-main-green text-white mx-auto flex p-2 rounded-lg">
                                Agregar reserva
                            </button>
</body>
@endsection