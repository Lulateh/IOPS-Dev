...
<div class="flex-container flex items-end justify-center mt-8">
    ...
    <div class="inline-block align-bottom text-left overflow-hidden mt-30"> 
        ...
        <div class="text-center "> 
            ...
            <div class="lg:flex lg:flex-row md:grid max-sm:grid  gap-8"> 
                ...
                <div class="flex-col ">
                    ...
                    <div> 
                      <div class="bg-lilac bg-opacity-20 rounded-lg  p-2 mb-6 font-Coda font-semibold columns-2 lg:w-[38rem] lg:h-[12rem] md:w-[40rem] max-sm:w-[24rem] max-sm:h-[14rem]">
    
                      <div class="flex-col text-base text-left lg:mt-10 md:mt-10 lg:ml-10 md:ml-10 max-sm:pt-4 ">
  ...
  <div class="flex items-center">
    ...
    <p>Fecha de entrega: {{ $existingReservation['fecha_salida']}}</p>
                        ...
                        <button onclick="showModalEditar({ 
                            ...
                            })" class="align-end hover:bg-blue-900 bg-main-blue p-2 lg:ml-32 md:ml-32 max-sm: max-sm:w-[4.4rem] m-4 lg:mt-14 md:mt-14 max-sm:mt rounded-lg">
                        ...
                        @endphp
                        <div class="bg-lilac max-sm:w-[24rem] bg-opacity-20 rounded-lg p-10 text-left"> 
                            <form action="{{ route('update.productReservation', ['id' => $existingReservation->id ]) }}" method="POST" >
                                ...
                                <div class="ml-2 mb-4">
                                    ...
                                    <select id="productSelect" name="productSelect" class="block appearance-none w-[31.6rem] text-center border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:shadow-outline max-sm:w-[18rem]" style="background-color: rgb(255, 255, 255);">
                                ...
                                Cantidad del producto</label>
                                    <input class="rounded-lg py-2 mt-1 mb-2 bg-white w-[31.5rem] max-sm:w-[18rem]" type="number" id="productCant" name="productCant" value="{{ old('productCant') }}" required><br>
                                @if ($errors->any())
...
<div id="editClientModal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50 ">
    <div class="bg-white rounded-lg p-6 lg:w-1/3 md:w-1/3 max-sm:w-[20rem]">
