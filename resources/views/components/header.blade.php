...
<div id="sidebar" class="fixed hidden basis-1/3 md:basis-1/5 h-[calc(100vh-85px)] w-60 overflow-y-auto" style="background-color: rgb(11, 83, 81);">
    <div class="flex flex-col font-Coda justify-center text-center mt-20 text-main-blue">
        ...
        <h2 class="text-3xl font-bold mb-6 border-b-2 pb-2 border-main-blue">Menu</h2>
            <div class="flex columns-2 px-4 py-2 text-lg md:text-lg  bg-main-blue text-gray-100">
