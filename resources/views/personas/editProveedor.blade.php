...
<div class="mt-8">
   ...
   <div class= "flex justify-center">
    <div class="justify-items-center mt-4 bg-lilac bg-opacity-20 w-3/4 p-2 lg:p-10 rounded-lg shadow-lg lg:mt-10">
    <h1 class="font-Poppins font-bold text-center text-3xl mb-10">Editar Proveedor</h1>
        ...
        <form action="{{ route('proveedores.update', ['id' => $proveedor->id]) }}" method="POST">
            @csrf
            @method('PUT') 
            <div class="grid-cols-1 grid md:justify-items-center lg:grid-cols-2 gap-2 lg:gap-8 font-Poppins ">
            <div class="lg:ml-16">
        ...
        <div class="relative inline-block mb-5">
            <input type="text" name="nombre" value="{{ $proveedor->nombre_proveedor }}" class="xl:w-[24rem]  lg:w-[12rem] p-1 rounded-lg" style="background-color: rgb(255, 255, 255);">
        </div>
    </div>
    ...
    <div class="">
        <label class="flex items-center mb-2 font-semibold">
            ...
            <input type="email" name="email" value="{{ $proveedor->email }}" class="xl:w-[24rem]  lg:w-[12rem] p-1 rounded-lg" style="background-color: rgb(255, 255, 255);">
    </div>
<div class="lg:ml-16">
                    <label class="flex items-center  mb-2 font-semibold">
    ...
    <input type="text" name="telefono" value="{{ $proveedor->telefono }}" class="xl:w-[24rem]  lg:w-[12rem]  p-1 rounded-lg text-black" style="background-color: rgb(255, 255, 255);" required 
       maxlength="10" 
       pattern="[0-9]{1,10}" 
...
Estado</label>
    <select name="estado" class="xl:w-[24rem]  lg:w-[12rem] p-1 rounded-lg" style="background-color: rgb(255, 255, 255);">
        ...
        <option value="inactivo" {{ $proveedor->estado == 'inactivo' ? 'selected' : '' }}>Inactivo</option>
            ...
            <div class="flex justify-center mt-10 md:my-6">
