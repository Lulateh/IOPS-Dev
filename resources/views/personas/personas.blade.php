...
<section class="flex columns-2 mt-16">
    ...
    <div class="basis-1/6">
        ...
        <a href="{{route('personas')}}"> <svg class="mx-auto mb-8 transition-all duration-300 hover:w-24 hover:h-24" xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 90 90" fill="none">
        <circle class="hover:fill-[#717EC3]" cx="45" cy="45" r="45" fill="#26413C"/>
