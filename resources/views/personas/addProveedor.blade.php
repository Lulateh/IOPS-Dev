...
<div class= "flex justify-center">
    <div class=" mt-4 bg-lilac bg-opacity-20 w-11/12  p-10 rounded-lg shadow-lg lg:mt-10">
        ...
        <form action="{{ route('proveedor.add') }}" method="POST" class="w-full">
            ...
            <div class=" grid-cols-1 md:justify-items-center grid lg:grid-cols-2 gap-2 font-Poppins">
                <div class="lg:ml-20">
                    ...
                    <div class="">
                        <label class="flex items-start mb-2 font-semibold">
                ...
                <button class="text-white bg-main-blue group hover:bg-blue-900  px-6 py-2 rounded-lg font-Poppins flex items-center relative">
                        ...
                        <span class="ml-8 font-Poppins text-white">Agregar Proveedor</span>
                </button>
                </div>
        </form>
    </div>
