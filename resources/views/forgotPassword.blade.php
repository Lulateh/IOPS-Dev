...
<div class="mt-16 mb-5">
    <a href="{{ route('login') }}" class="ml-20 text-black font-Coda hover:underline text-5xl md:text-4xl">  
        ← Volver
    </a>
</div>
...
<form action="{{ route('checkEmail') }}" method="POST" class="px-4">
    ...
    <h3 class="text-xl md:text-2xl font-Coda mb-4 text-center">Ingresa tu correo electrónico</h3>
        <div class="mb-6">
