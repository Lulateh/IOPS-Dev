  ...
  <section>
    ...
    <div class="basis-1/6">
           <a href="{{route('home')}}"> <svg class="mx-auto mb-8 transition-all duration-300 hover:w-24 hover:h-24" xmlns="http://www.w3.org/2000/svg" width="90" height="70" viewBox="0 0 120 120" fill="none">
            ...
            <a href="{{route('incoming')}}"> <svg class="mx-auto mb-8 transition-all duration-300 hover:w-24 hover:h-24" xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 90 90" fill="none">
