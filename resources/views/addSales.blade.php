...
<!-- --------------HEADER-------------- -->
<div class="mt-8 mb-8">
    <a href="{{ route('sales') }}" class="ml-20 text-main-green font-Coda hover:underline text-4xl">  
    ← Volver
   </a>
 </div>
<!-- --------------HEADER-------------- -->
    ...
    <div class="inline-block align-bottom text-left overflow-hidden mt-30"> 
        ...
        <div class="text-center mt-2"> 
            ...
            <div class="flex flex-row gap-4 mt-4"> 
                ...
                <div class="bg-card-bg rounded-lg mr-5">

                    <div class="m-5 overflow-y-scroll h-[26rem]"> 

                        <div class="flex border border-black h-14 w-96 mt-1 ml-2 m-2">
                            ...
                            <div class="flex ml-48 mt-[0.76rem]">
                ...
                <div class="flex-col">
                    ...
                    <div> 
                      ...
                      <div class="bg-card-bg rounded-lg p-10 text-left"> 
                        ...
                        <input class="rounded-lg my-2 bg-white w-96" type="text" id="productMarca" name="productMarca" required><br>
                        ...
                        <button class="text-white bg-main-green mt-4 ml-24 px-4 py-1 rounded-lg font-Poppins">
                          Agregar producto
                        </button>
