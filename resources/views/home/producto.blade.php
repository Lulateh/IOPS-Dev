...
<div >
    <a class="ml-20 mt-4 flex" href="{{ route('home') }}">
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" class="mt-1 w-6 fill-black"><path d="m313-440 224 224-57 56-320-320 320-320 57 56-224 224h487v80H313Z"/></svg>
        <p class="font-Coda text-black text-2xl"> Volver</p>
    </a>
</div>
...
<section class = "columns-2 mt-4 ml-[25rem] flex ">
    ...
    <div class="content-center">
        ...
        <h1 class="text-3xl font-bold uppercase">{{$existingProduct['nombre']}}</h1>
        ...
        <div class="mt-4 flex">
            <a href="{{ route('product.redirect.edit', $existingProduct['id'])}}" class="text-white bg-main-blue hover:bg-secondary-green px-6 py-2 rounded-lg font-Coda">Editar</a>
