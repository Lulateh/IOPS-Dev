...
<div class="mt-6 flex justify-center">
    <div class="bg-lilac bg-opacity-20 shadow-lg px-5 py-3 rounded-lg w-full sm:w-11/12 md:w-9/12 lg:w-8/12">
        <form action="{{ route('product.edit', $existingProduct->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-16 gap-y-6">
                <div >
                    <label for="productName" class="font-Coda flex">
                    ...
                    @enderror
                    <label for="brand" class="font-Coda flex items-center"> 
                    ...
                    @error('brand')
                        <div class="text-red-600 mt-1">{{ $message }}</div>
                    @enderror
                    <label for="price_income" class="font-Coda flex items-center"> 
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="mr-2" viewBox="0 0 16 16">
                    ...
                    @error('price_income')
                        <div class="text-red-600 mt-1">{{ $message }}</div>
                    @enderror
                    <label for="price_sale" class="font-Coda flex items-center">  
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="mr-2" viewBox="0 0 16 16">
                    ...
                    @error('price_sale')
                        <div class="text-red-600 mt-1">{{ $message }}</div>
                    @enderror
                    <label for="location" class="font-Coda flex items-center"> 
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="mr-2" viewBox="0 0 16 16">
                ...
                <div >
                    <label for="details" class="font-Coda text-wrap flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="mr-2" viewBox="0 0 16 16">
                    ...
                    @error('expiration')
                        <div class="text-red-600 mt-1">{{ $message }}</div>
                    @enderror
                    <label for="img" class="font-Coda flex items-center mb-2"> 
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="=026" fill="currentColor" class="mr-2" viewBox="0 0 16 16">
                            <path d="M6.002 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"/>
                            <path d="M1.5 2A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2zm13 1a.5.5 0 0 1 .5.5v6l-3.775-1.947a.5.5 0 0 0-.577.093l-3.71 3.71-2.66-1.772a.5.5 0 0 0-.63.062L1.002 12v.54L1 12.5v-9a.5.5 0 0 1 .5-.5z"/>
                        </svg>
                        Imagen </label> 
                    <input type="file" id="img" name="img" accept="image/*, .jpg, .jpeg, .png" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:bg-main-blue file:hover:bg-blue-900 file:text-white"><br>
                    @error('img')
                        <div class="text-red-600 mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <button class="text-white bg-main-blue hover:bg-blue-900 group  px-6 py-2 rounded-lg font-Poppins flex items-center relative">
                ...
                <span class="ml-8 font-Poppins text-white">Editar Producto</span>
            </button>
        </div>
                                </div>
        </form>
